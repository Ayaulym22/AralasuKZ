    ...
    <div class="row">
        ...
        <div class="col-6">
            <%
                ...
                Chats chat  = (Chats)request.getAttribute("chats");

                if(messages!=null){
            %>
            <div class="card" style="margin-top: 20px;">
            <%
                for(Messages c : messages){
            %>

                <div class="row no-gutters">
                    <div class="col-md-3" style="text-align: center">
                        <img style="height: 70px;width: 70px;margin-top: 25px;margin-bottom:5px;border-radius: 360px;"  src="<%=c.getSender().getPicture_url()%>" class="card-img" alt="...">
                    </div>
                    <div class="col-md-9">
