    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <div class="list-group" id="list-tab" role="tablist" style="width: 250px">
                ...
                %>
                <a class="list-group-item list-group-item-action" href="/profile" role="tab" aria-controls="home"><strong style="color: #000";><%=currentUser.getFull_name()%>,<%=age%>years</strong></a>
        ...
        <div class="col-sm-6">
            <button type="button" class="btn btn-primary btn-sm float-left" data-toggle="modal" data-target="#exampleModal" style="background-color: #ffb5b3">
                + ADDS NEW
            </button>
            <br/>
            <br/>
            ...
            <div class="card">
                ...
                %>
                    Posted on September <%=day_1%>, <%=year_1%> by <strong style="color: #91bbe9"><%=p.getAuthod_id().getFull_name()%></strong>
        ...
        <div class="card" style="width: 280px;">
            <div class="card-header" style="background-color: #ffb5b3">
                <strong style="background-color: #ffffff">My Games </strong>
            </div>
